        ...
        <section className={`${styles.header_section} d-flex`}>
          ...
          >
            <div className={` d-flex direction-column`}>
              <span className={`${styles.sub_header}`}>Kapitallaşma</span>
          ...
          <div className={`${styles.paragraph_section} d-flex align-center`}>
            <p>
              <span className={`${styles.bold_paragraph}`}>
                TWC inanır ki, strateji və marketinq layihələrinin ilkin
                mərhələsi bazar araşdırmasından başlayır.
              </span>
              <br />
              Dəqiq müəyyən edilmiş məqsədlər və effektiv metodologiya uğurlu
              bazar araşdırmasının əsas göstəriciləridir. Bazar araşdırması yeni
              müəssisəyə resurslar sərf etmədən öncə yeni məhsul və ya xidmətin
              işə salınmasının mexanizmlərini və bunun mümkünlüyünü müəyyən
              etməkdə, nəticə olaraq önəmli biznes qərarların qəbul edilməsində
              həlledici vasitə ola bilər. Dəyişən iş mühiti, müştərilər və
              onların tələbləri səbəbindən bazar araşdırması davamlı bir proses
        ...
        <div className={`${styles.content_container}`}>
          <section>
            ...
            <div className={`${styles.section_image_desc}`}>
              <p>
                Bazar araşdırması marketinqin əsas elementi olub, rəqabət
                mühitində bazar dinamikası üçün strategiya və taktikaların
                işlənib hazırlanmasında məlumat bazası yaradır. Bu tədqiqatın
                mahiyyəti bazarın keyfiyyət və kəmiyyət təhlilindən ibarətdir
                ki, onun da məqsədi bazarın potensial ölçüsünü, məhsul və
                xidmətlərə mövcud tələbi, rəqabət səviyyəsini, rəqabət mühitinin
                xüsusiyyətlərini müəyyən etməkdir.
              </p>
              <br />
              <p>
                TWC komandası müxtəlif sənaye sahələrində dövlət və özəl
                şirkətlər üçün bazar araşdırmalarının aparılmasında böyük bilik
                və təcrübəyə malikdir. Logistika, neft və qaz, pərakəndə satış,
                alkoqol, FMCG, HORECA istehsalı və istehlak malları sənayesi
                kimi sahələrdə bir çox uğurlu araşdırmalarımız şirkətlərə təqdim
                olunmuşdur.
              </p>
            </div>
          </section>
