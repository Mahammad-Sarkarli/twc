    ...
    <div>
      ...
      <div className={`${styles.container}`}>
        ...
        >
          ...
          >
            <p>
              Azərbaycan 1991-ci ildə müstəqilliyini bərpa etmiş suveren bir
              ölkədir. Müstəqillik əldə etdikdən sonra Azərbaycan iqtisadiyyatı
              müxtəlif sənaye sahələrinə, xüsusilə neft-qaz sektoruna birbaşa
              xarici investisiyalar cəlb etmişdir. Dinamik iqtisadi inkişafı
              xətti ilə davam edən Azərbaycan, turizm, tikinti və s. kimi sənaye
              sahələrində birbaşa xarici investisiyalar almağa nail olmuşdur.
              Bankçılıq, infrastruktur və hüquq sistemindəki təkmilləşdirmələr
              ölkəyə dünyanın hər yerindən yeni bizneslərin axın etməsi və daha
              yaxşı biznes ekosisteminin yaradılmasına səbəb olmuşdur. Bu
              baxımdan, Doing Business in Azerbaijan xarici investorlar üçün bir
              fürsət kimi dəyərləndirilə bilər. Bunun səbəbi işğaldan azad
              olunmuş Dağlıq Qarabağ ərazisində azad iqtisadi zonaların sayının
              artması, tikinti və infrastrukturun inkişafı, vergi və hüquq
              sisteminin təkmilləşdirilməsidir. Şirkətimiz Azərbaycanda biznes
              qurmaq və xarici investorlara qərarlarında köməklik göstərmək
