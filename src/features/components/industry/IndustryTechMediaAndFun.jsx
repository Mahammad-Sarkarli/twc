  ...
  return (
    <div>
      ...
      <div className={`${styles.container}`}>
        ...
        <section className={`${styles.paragraph_section}`}>
          <p>
            TWC konsultantları regional ekspertlər və ideya liderləri ilə
            şirkətlərin fərqli mərhələlərdəki çətinliklərinə qarşı hərtərəfli
            strateji yanaşma təklif edir. Birlikdə biz möhkəm, pozitiv və
            davamlı dəyişiklik üçün təməl yaradırıq.
          </p>
        </section>
      </div>
    </div>
