    ...
    <div>
      ...
      <div className={`${styles.container}`}>
        ...
        <section className={`d-flex direction-column`}>
          ...
          <span className={`${styles.header_title}`}>Sənaye məhsulları</span>
        </section>
        <section className={`${styles.paragraph_section}`}>
          <p>
            Şirkətlərin hansı spesifik sənaye sektorunda olmaqlarından asılı
            olmayaraq ənənəvi biznesdən və əməliyyat modellərindən daha uzağa
            baxmağa və gələcəkdə necə dəyər yaradacaqlarını bilməyə ehitayacları
            var. Bir çoxu üçün, biznes modellərində cəsur dəyişikliklər etmək
            aydındır, amma bu dəyişikliyi necə etmək isə aydın deyil.
          </p>
        </section>
        ...
        <section className={`${styles.paragraph_section}`}>
          <p>
            Biz detallı industriya və bazar datalarını şirkətlərin əsas güclü
            tərəfləri ilə birləşdirərək hərəkətə keçilə bilən strategiyalara
            çeviririk. Biz inanırıq ki, hazırki qeyri-müəyyənlikdə, şirkətlər
            satışlarına olan təsirləri və iqtisadiyyatdakı dalğalanmaları
            yumşaltmaq üçün davamlı olaraq əməliyatlarının inkişaf etdirməyə və
