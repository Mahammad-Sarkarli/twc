    ...
    <div>
      ...
      <div className={`${styles.container}`}>
        ...
        <section className={`d-flex direction-column`}>
          ...
          <span className={`${styles.header_title}`}>Daşınmaz əmlak</span>
        </section>
        <section className={`${styles.paragraph_section}`}>
          <p>
            Dünyanın ən böyük investisiya kateqoriyası olan daşınmaz əmlak artıq
            şirkətlərin əvvəl düşündükləri kimi maliyyə resurslarını təhlükəsiz
            qoruyacağı liman rolunu oynamır. Texnologiyadakı dəyişikliklər,
            pandemiyanın təsiri və insanların daşınmaz əmlakdan istifadəsində
            olan dəyişikliklər industriyanın dinamikasının dəyişməsinə səbəb
            olur, lakin bu sektor bu vaxta qıdır innovasiyada geri qalıb.
          </p>
        </section>
        ...
        <section className={`${styles.paragraph_section}`}>
          <p>
            TWC daşınmaz əmlak liderlərinə öz lokasiyalarına və investisiya
            portfeli fokusuna əsasən industriyada olan dəyişiklikləri
            kapitallaşdirmağa kömək edir. Kapitallaşdırma, biznes modellərini
            dəyişdirmək və şaxələndirmək, yeni daxili bacarıqları inkişaf
            etdirmək və coğrafi olaraq genişləndirmək kimi fərqli formalarda ola
            bilər.
          </p>
        </section>
      </div>
