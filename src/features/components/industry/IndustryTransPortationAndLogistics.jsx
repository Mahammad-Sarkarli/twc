  ...
  return (
    <div>
      ...
      <div className={`${styles.container}`}>
        ...
        <section className={`${styles.paragraph_section}`}>
          <p>
            TWC transportasiya və logistika şirkətlərinin bütün təşkilati
            səviyyələri ilə əməkdaşlıq edərək onların şəbəkələrini
            genişləndirməkdə və müştəri ehtiyaclarına əsasən xidmətlərini
            təkmilləşdirilməsində kömək edir. Biz inanırıq ki, bu strategiyalari
            tətbiq edən şirkətlər uzun müddətli böyümə fürsətindən faydalanmaq
            üçün ən yaxşı mövqedə olacaqlar.
          </p>
        </section>
      </div>
    </div>
