      ...
      <div className={`${styles.container}`}>
        <section className={`${styles.topic_section} d-flex`}>
          ...
          >
            ...
            <p className={`${styles.topic_desc}`}>
              TWC cəmiyyətin və bizneslərin <br /> ən əhəmiyyətli problemlərini
              həll etmək üçün kreativliyin <br /> sərhədlərinin olmadığı yerdir
            </p>
          </div>
        </section>
        ...
        <section className={`${styles.topic_section} d-flex`}>
          ...
          >
            <span className={`${styles.sub_header}`}>LOREM IPSUM</span>
            <p className={`${styles.topic_desc}`}>
              Biz 2018-ci ildə qurulan Azərbaycanın ilk yerli menecment
              konsaltinq şirkətiyik.
            </p>
          </div>
          <div className={`${styles.image_section} `}>
        ...
        <section className={`${styles.topic_section} d-flex`}>
          ...
          >
            <span className={`${styles.sub_header}`}>LOREM IPSUM</span>
            <p className={`${styles.topic_desc}`}>
              Bugün biz ən böyük oyunçulara <br /> sənayeni müəyyən edən <br />{" "}
              problemləri həll etməkdə və <br /> davamlı biznes dəyəri <br />{" "}
              yaratmaqda kömək edirik.
            </p>
          </div>
        </section>
        ...
        <section className={`${styles.topic_section} d-flex`}>
          ...
          >
            <span className={`${styles.sub_header}`}>LOREM IPSUM</span>
            <p className={`${styles.topic_desc}`}>
              Komandamız özünə məhdudiyyət tanımayan və müştərilərə dəstək üçün
              özündə qlobal təcrübə və <br /> lokal anlayışı birləşdirənlərdən
              ibarətdir.
            </p>
          </div>
          <div className={`${styles.image_section} `}>
        ...
        >
          <div className={`${styles.image_item_section}`}>
            ...
            <p className={`${styles.image_item_desc}`}>
              Etdiyimiz və dediyimiz hər şeydə intellektual dürüstlük kodu
              izlənilməlidir.
            </p>
          </div>
          <div className={`${styles.image_item_section}`}>
            ...
            <p className={`${styles.image_item_desc}`}>
              Hər bir daxili və xarici TWC biznes əlaqəsi uzun müddətli
              olmalıdır.
            </p>
          </div>
          <div className={`${styles.image_item_section}`}>
            ...
            <p className={`${styles.image_item_desc}`}>
              Sıradan olmayan nəticələr əldə etmək üçün hər bir təcrübəyə,
              bacarığa və biliyə hörmət edilməlidir.
            </p>
          </div>
        </div>
      </section>
