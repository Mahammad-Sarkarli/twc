      ...
      <section className={`${styles.container} d-flex`}>
        ...
        >
          ...
          <section className={`${styles.article_paragraph}`}>
            ...
            <p>
              Qlobal bazarlarda startaplara olan marağın dollar baxımından
              trendi son illərlə müqayisədə hazırda hər dörd startap böyümə
              mərhələsi üçün rekord həddədir. Ancaq TWC-yə görə Azərbaycanın
              startap ekosistemi üç səbəbə əsasən qlobal tempi tutmaqdan bir
              xeyli uzaqdır, baxmayaraq ki, son onillikdə startaplara olan maraq
              həm sahibkarlarda, həm də istiqamətlənməsi mükəmməlikdən uzaq olan
              dövlət institutlarında yaranmışdır.
              <ul className={`${styles.list_group}`}>
                <li>
                  Birincisi, sahibkarlar tərəfindən sürətli MVP-lərin və sürətli
                  feedback loopların yaradıla bilinməməsidir.
                </li>
                <li>İkincisi, yerli investorlara keçidin limitli olması.</li>
                <li>
                  Üçüncü, dövlət institutları tərəfindən açıq olan maliyyələşmə
                  kriteriyalarının sərt və qeyri-müəyyən olması.
                </li>
              </ul>
            </p>
            <p className={`${styles.paragraph_title}`}>Bizim dəstəyimiz:</p>
            <p>
              TWC-nin peşəkar və startap təcrübəsi olan biznes konsultantlarının
              həm yerli həm də xarici bazarlarda startaplara fərqli böyümə
              mərhələlərində dəstəyi var. Əməliyyat tərəfdən, buna ideyanın
              qiymətlədirilməsi, MVP-nin yaradılması, ilk istifadəçilərin cəlb
              edilməsi, maliyyələşməyə hazırlanma, PMF-ə çatma və online &
              offline auditoriyanın qurulması daxildir. Maliyyələşmə tərəfdən,
              buna pre-seed, seed, Stage A, Stage A+ və Exit (VC, PE, Strateji
              Alıcı və IPO) maliyyələşməsi daxildir.
            </p>
